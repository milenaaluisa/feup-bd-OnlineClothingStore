...
Create Table Encomenda(
  idEncomenda int PRIMARY KEY CONSTRAINT nn_id_encomenda NOT NULL CONSTRAINT u_id_encomenda Unique,
...
Create table Envio1(
  pesoTotal real (4,2) PRIMARY KEY CONSTRAINT nn_peso_total NOT NULL CHECK(pesoTotal>=0),
